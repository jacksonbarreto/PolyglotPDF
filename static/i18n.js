...
,
  "pt": {
    ...
    "12": "Total de artigos:",
    "13": "Ver todos >",
    "14": "Editor do ficheiro de configuração",
    "15": "Guardar todas as alterações",
    "16": "Pedido de API LLM chinesa",
    "17": "Pedir através da plataforma Volcengine:",
    "18": "Link de pedido: <a href=\"https://www.volcengine.com/product/doubao/\" style=\"color: #0066cc; text-decoration: none;\">Volcano-Doubao</a>",
    "19": "Modelos suportados: Doubao, modelos da série Deepseek",
    "20": "Pedir através da plataforma Alibaba Cloud:",
    "21": "Link de pedido: <a href=\"https://cn.aliyun.com/product/tongyi?from_alibabacloud=&utm_content=se_1019997984\" style=\"color: #0066cc; text-decoration: none;\">Alicloud-Qwen</a>",
    "22": "Modelos suportados: Qwen-Max, Qwen-Plus e outros modelos da série Qwen",
    "23": "contador:",
    "24": "PPC:",
    "25": "API do modelo de tradução",
    "26": "Serviços de OCR",
    "27": "Configuração predefinida",
    "28": "Adicionar literatura à lista de leitura",
    "29": "Arraste e largue os ficheiros aqui ou <span class=\"upload-link\" onclick=\"triggerFileInput()\"> clique para carregar</span>",
    "30": "Até 12 ficheiros de cada vez, cada um com o máximo de 200 MB",
    "31": "Formatos suportados: PDF, XPS, EPUB, FB2, CBZ, MOBI",
    "32": "Aguarde. Pode consultar o progresso da tradução no separador de leitura recente.",
    "33": "Definições da API de tradução",
    "34": "API OpenAI",
    "35": "API de tradução Doubao",
    "36": "API de tradução Qwen",
    "37": "API Deepseek",
    "38": "API deepl",
    "39": "API de tradução Youdao",
    "40": "Modo global de OCR desactivado por predefinição",
    "41": "Modo de tradução activado",
    "42": "Gestão em lote",
    "43": "Seleccionar tudo",
    "44": "Eliminar",
    "45": "Mapa mental",
    "46": "Resumo",
    "47": "    Notas:\n\n<ul>\n<li>Os modos OCR e Line estão desactivados por predefinição\n<ul> PPC (páginas por chamada)\n<li>O OCR é usado para digitalizar PDFs baseados em imagem</li>\n<li>O modo Line é usado para traduzir PDFs com conteúdo esparso</li>\n</ul>\n</li>\n<li>A funcionalidade de tradução está activada por predefinição</li>\n<li>Depois de alterar o modelo de tradução, introduza o nome do modelo e a chave correspondentes nas opções da API de tradução</li>\n</ul>",
    "48": "API de tradução Grok",
    "49": "API de terceiros",
    "50": "API de tradução GLM",
    "51": "API de tradução Bing",
    "52": "Prompt de tradução",
    "53": "API 302.ai"
  }
